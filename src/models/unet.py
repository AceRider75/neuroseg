...
class AttentionGate(nn.Module):
    ...
    Learns spatial attention maps to focus on relevant regions (tumor boundaries)
    ...
    def __init__(self, F_g, F_l, F_int):
        """
        Args:
            F_g: channels from gating signal (decoder/upsampled)
...
class Up(nn.Module):
    """Upscaling then double conv with attention gate on skip connection"""
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        # Attention gate: gating signal has in_channels//2 channels after upconv,
        # skip connection has out_channels channels
...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        # Dropout at bottleneck to prevent overfitting on deepest features
